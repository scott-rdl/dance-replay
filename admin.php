...
<section>
    ...
    <form class="admin" method="post" action="">
        ...
        <input type="text" name="show-name" placeholder="TITLE" required /><br />
        <input type="number" name="length" placeholder="120" size="5" required /> min /
        <input type="number" name="size" placeholder="15" size="5" step="0.1" required /> Go<br />
        <input type="url" name="url" placeholder="https://drive.google.com/uc?export=download&id=..." required><br />
